...
if command -v curl >/dev/null 2>&1; then
  source <(curl -fsSL https://raw.githubusercontent.com/denis-ev/ProxmoxVE/refs/heads/paperless-ngx-fix/misc/core.func)
  load_functions
  #echo "(create-lxc.sh) Loaded core.func via curl"
elif command -v wget >/dev/null 2>&1; then
  source <(wget -qO- https://raw.githubusercontent.com/denis-ev/ProxmoxVE/refs/heads/paperless-ngx-fix/misc/core.func)
  load_functions
